            ...
            extensions = {
                zoxide = {
                    ...
                    path_display = function(opts, path)
                        ...
                        transformed_path = home and transformed_path:gsub("^" .. vim.pesc(home), "~")
                            or transformed_path
                        ...
                        local calc_result_length = function(truncate_len)
                            ...
                            local len = vim.api.nvim_win_get_width(results_win)
                        ...
                        transformed_path = icon
                            .. require("plenary.strings").truncate(
                                transformed_path,
                                opts.__length - opts.__prefix - icon_width,
                                nil,
                                -1
                            )
